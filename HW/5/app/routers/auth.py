...
# 5 registration attempts per minute per IP — prevents mass account creation
_register_limiter = make_rate_limiter("register", limit=5, window_seconds=60)
...
def register(data: UserRegister, db: Session = Depends(get_db)):
    ...
    Rate limited: 5 requests/min per IP (Sliding Window).
    """
